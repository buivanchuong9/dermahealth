      ...
      <div style={{ display: "flex", gap: 5, marginBottom: 4 }}>
        {[1, 2, 3].map((i) => (
          <motion.div
            key={i}
            animate={{
              background: i <= strength ? colors[strength] : "rgba(0,0,0,0.08)",
            }}
    ...
    try {
      ...
      setError(
        err instanceof ApiError
          ? err.message
          : REGISTRATION_MESSAGES.genericError,
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          variants={leftItem}
          style={{ opacity: 0.3, fontSize: 11.5, zIndex: 1, marginTop: 16 }}
        >
        ...
        >
          ...
          <motion.div
            ...
            animate={{
              boxShadow: [
                ...
                "0 0 0 4px rgba(93,169,234,0.14)",
                "0 0 0 0 rgba(93,169,234,0)",
              ],
            }}
            transition={{
          ...
          <div
            style={{
              ...
              boxShadow:
                "0 4px 24px rgba(16,34,90,0.08), inset 0 1px 0 rgba(255,255,255,1)",
            }}
          >
            {/* Header */}
            <motion.div
            ...
            <motion.div
              ...
              transition={{ duration: 0.5, ease: E_OUT, delay: 0.62 }}
              style={{ transformOrigin: "center" }}
            >
              <Divider
                plain
                style={{ fontSize: 12, color: "#9ca3af", margin: "18px 0" }}
              >
                Hoặc đăng ký bằng
              </Divider>
            </motion.div>
