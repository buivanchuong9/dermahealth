...
export function createSeedWorld(): DomainWorld {
  const users: User[] = [
    ...
    { id: 'U-0002', name: 'Đào Văn Dương', role: 'super_administrator', department: 'Ban quản trị hệ thống' },
    { id: 'U-0003', name: 'Nguyễn Mạnh Cường', role: 'super_administrator', department: 'Ban quản trị hệ thống' },
    { id: 'U-0004', name: 'Phạm Thị Hồng Chúc', role: 'super_administrator', department: 'Ban quản trị hệ thống' },
    { id: 'U-0005', name: 'Bùi Văn Chương', role: 'super_administrator', department: 'Ban quản trị hệ thống' },
    { id: 'U-0006', name: 'Bs. Nguyễn Thị An', role: 'doctor', department: 'Khoa Da liễu', specialty: 'Da liễu', online: true },
    { id: 'U-0007', name: 'ĐD. Trần Thị Bích', role: 'nurse', department: 'Khoa Da liễu' },
    { id: 'U-0008', name: 'Phạm Thị Hoa', role: 'receptionist', department: 'Tiếp đón' },
    { id: 'U-0009', name: 'KTV. Lê Văn Sơn', role: 'lab_technician', department: 'Xét nghiệm' },
    { id: 'U-0010', name: 'KTV. Đỗ Thị Mai', role: 'imaging_technician', department: 'Chẩn đoán hình ảnh' },
    { id: 'U-0011', name: 'DS. Vũ Văn Long', role: 'pharmacist', department: 'Dược' },
    { id: 'U-0012', name: 'Ngô Thị Lan', role: 'care_coordinator', department: 'Điều phối chăm sóc' },
    { id: 'U-0013', name: 'Bùi Văn Tùng', role: 'customer_care_employee', department: 'Chăm sóc khách hàng' },
    { id: 'U-0014', name: 'Trịnh Văn Đức', role: 'system_administrator', department: 'CNTT' },
    { id: 'U-0015', name: 'Đặng Thị Thu', role: 'clinical_process_designer', department: 'Thiết kế quy trình' },
  ];

  const patients: Patient[] = [
    {
      id: 'PT-1029', code: 'PT-1029', name: 'Nguyễn Văn A', primaryDoctorId: 'U-0006',
  ...
  const appointments: Appointment[] = [
    { id: 'APT-1001', patientId: 'PT-1029', doctorId: 'U-0006', date: '15/09/2023', time: '10:00', mode: 'in_person', status: 'done', encounterId: 'ENC-1000' },
    { id: 'APT-1002', patientId: 'PT-1029', doctorId: 'U-0014', date: '22/10/2023', time: '14:00', mode: 'in_person', status: 'upcoming' },
    { id: 'APT-1003', patientId: 'PT-1029', doctorId: 'U-0006', date: '15/10/2023', time: '09:00', mode: 'in_person', status: 'done', encounterId: 'ENC-1001' },
    { id: 'APT-2001', patientId: 'PT-1029', doctorId: 'U-0006', date: '13/07/2026', time: '09:00', mode: 'in_person', status: 'upcoming', encounterId: 'ENC-2001', clinicLocationId: 'CS-HCM-01', clinicName: 'DermaHealth TP.HCM', department: 'Khoa Da liễu', consultationType: 'Khám tại phòng khám' },
  ];
  ...
  const encounters: MedicalEncounter[] = [
    {
      ...
      currentDoctorId: 'U-0006', aiAssessmentIds: [], doctorReviewIds: [], diagnosisIds: ['DX-1000'],
    ...
    },
    {
      ...
      estimatedWaitMinutes: 0, createdAt: '15/10/2023 09:00', updatedAt: '15/10/2023 10:05', currentDoctorId: 'U-0006',
    ...
    },
    {
      ...
      currentDoctorId: 'U-0006', aiAssessmentIds: [], doctorReviewIds: [], diagnosisIds: ['DX-1002'],
    ...
    },
    {
      ...
      currentDoctorId: 'U-0006', aiAssessmentIds: [], doctorReviewIds: [], diagnosisIds: [], clinicalOrderIds: [],
  ...
  const doctorReviews: DoctorReview[] = [
    {
      id: 'DRV-1001', encounterId: 'ENC-1001', aiAssessmentId: 'AIA-1001', doctorId: 'U-0006', action: 'partial',
  ...
  const doctorDiagnoses: DoctorDiagnosis[] = [
    { id: 'DX-1000', encounterId: 'ENC-1000', doctorId: 'U-0006', status: 'signed', conditionName: 'Mụn trứng cá độ III (Acne Vulgaris)', conditionCode: 'ACNE', isAdditionalToAI: false, recordedAt: '15/09/2023 10:40' },
    {
      id: 'DX-1001', encounterId: 'ENC-1001', doctorId: 'U-0006', status: 'confirmed', conditionName: 'Mụn trứng cá độ III (Acne Vulgaris)',
    ...
    { id: 'DX-1002', encounterId: 'ENC-1002', doctorId: 'U-0006', status: 'signed', conditionName: 'Mụn trứng cá độ I-II (đang cải thiện)', conditionCode: 'ACNE', isAdditionalToAI: false, recordedAt: '20/10/2023 09:30' },
  ];

  const clinicalPlans: ClinicalPlan[] = [
    { id: 'PLAN-1000', encounterId: 'ENC-1000', doctorId: 'U-0006', diagnosisId: 'DX-1000', summary: 'Kháng sinh Doxycycline 7 ngày + vệ sinh da', approvedAt: '15/09/2023 10:45' },
    { id: 'PLAN-1001', encounterId: 'ENC-1001', doctorId: 'U-0006', diagnosisId: 'DX-1001', summary: 'Tretinoin 0.05% + Omega-3 + kem chống nắng SPF50+, xét nghiệm máu loại trừ nhiễm khuẩn, tái khám sau 4 tuần', approvedAt: '15/10/2023 09:45' },
  ];

  const clinicalOrders: ClinicalOrder[] = [
    { id: 'ORD-1001', encounterId: 'ENC-1001', type: 'laboratory', orderedByDoctorId: 'U-0006', justification: 'Loại trừ nhiễm khuẩn toàn thân trước khi cân nhắc kháng sinh', status: 'completed', assignedRole: 'lab_technician', createdAt: '15/10/2023 09:46', resultId: 'RES-1001' },
  ];

  const clinicalResults: ClinicalResult[] = [
    { id: 'RES-1001', orderId: 'ORD-1001', summary: 'Công thức máu bình thường, CRP không tăng', abnormal: false, recordedAt: '15/10/2023 10:05', recordedBy: 'U-0009' },
  ];
  ...
  const workflowInstances: WorkflowInstance[] = [
    { id: 'WFI-1001', encounterId: 'ENC-1001', templateId: 'WFT-DERM', templateVersionId: 'WFV-DERM-1', status: 'active', activatedBy: 'U-0006', activatedAt: '2023-10-15T09:50:00.000Z', taskIds: ['TASK-1001', 'TASK-1002', 'TASK-1003', 'TASK-1004', 'TASK-1005', 'TASK-1006'], ...seedWorkflowIdentity },
  ];

  const workflowTasks: WorkflowTask[] = [
    { id: 'TASK-1001', instanceId: 'WFI-1001', encounterId: 'ENC-1001', stepCode: 'VITALS', name: 'Đo sinh hiệu', responsibleRole: 'nurse', department: 'Khoa Da liễu', status: 'completed', assigneeId: 'U-0007', dependsOnStepCodes: [], slaMinutes: 20, priority: 'medium', urgency: 'routine', createdAt: '15/10/2023 09:00', startedAt: '15/10/2023 09:05', completedAt: '15/10/2023 09:14', reworkCount: 0, patientArrivalStatus: 'in_room' },
    { id: 'TASK-1002', instanceId: 'WFI-1001', encounterId: 'ENC-1001', stepCode: 'CONSULT', name: 'Bác sĩ thăm khám', responsibleRole: 'doctor', department: 'Khoa Da liễu', status: 'completed', assigneeId: 'U-0006', dependsOnStepCodes: ['VITALS'], slaMinutes: 30, priority: 'medium', urgency: 'routine', createdAt: '15/10/2023 09:14', startedAt: '15/10/2023 09:16', completedAt: '15/10/2023 09:45', reworkCount: 0, patientArrivalStatus: 'in_room' },
    { id: 'TASK-1003', instanceId: 'WFI-1001', encounterId: 'ENC-1001', stepCode: 'LAB_DRAW', name: 'Lấy mẫu xét nghiệm máu', responsibleRole: 'lab_technician', department: 'Xét nghiệm', status: 'completed', assigneeId: 'U-0009', dependsOnStepCodes: ['CONSULT'], slaMinutes: 30, priority: 'medium', urgency: 'routine', createdAt: '15/10/2023 09:45', startedAt: '15/10/2023 09:50', completedAt: '15/10/2023 10:05', reworkCount: 0, patientArrivalStatus: 'arrived' },
    ...
    { id: 'TASK-1005', instanceId: 'WFI-1001', encounterId: 'ENC-1001', stepCode: 'PHARMACY', name: 'Cấp phát thuốc', responsibleRole: 'pharmacist', department: 'Dược', status: 'in_progress', assigneeId: 'U-0011', dependsOnStepCodes: ['CONSULT'], slaMinutes: 20, priority: 'medium', urgency: 'routine', createdAt: '15/10/2023 09:45', startedAt: '15/10/2023 10:00', reworkCount: 0, patientArrivalStatus: 'not_arrived' },
  ...
  const clinicalDocuments: ClinicalDocument[] = [
    { id: 'DOC-1001', encounterId: 'ENC-1001', clinicalOrderId: 'ORD-1001', type: 'lab_report', fileName: 'xet-nghiem-mau-2023-10-15.pdf', fileHash: 'sha256:mock-8f21a', version: 1, uploadedBy: 'U-0009', uploadedAt: '15/10/2023 10:05', reviewStatus: 'reviewed', signatureStatus: 'unsigned' },
  ];

  const prescriptions: Prescription[] = [
    { id: 'RX-1000', encounterId: 'ENC-1000', doctorId: 'U-0006', issuedAt: '15/09/2023 10:45', medications: [
    ...
    { id: 'RX-1001', encounterId: 'ENC-1001', doctorId: 'U-0006', issuedAt: '15/10/2023 09:46', medications: [
  ...
  const medicalRecords: MedicalRecord[] = [
    {
      ...
      signedBy: 'U-0006', signedAt: '15/09/2023 11:10', addenda: [],
    ...
    },
    {
      ...
      signedBy: 'U-0006', signedAt: '20/10/2023 09:45', addenda: [],
  ...
  const notifications: Notification[] = [
    { id: 'NOTIF-1', event: 'ai_assessment_ready', recipientId: 'U-0006', recipientRole: 'doctor', channel: 'in_app', status: 'delivered', message: 'Đánh giá sơ bộ AI đã sẵn sàng để xem xét cho BN PT-1029.', relatedPatientId: 'PT-1029', relatedEncounterId: 'ENC-1001', createdAt: '15/10/2023 09:18', deliveredAt: '15/10/2023 09:18', retryCount: 0, read: false },
    { id: 'NOTIF-2', event: 'task_assigned', recipientId: 'U-0011', recipientRole: 'pharmacist', channel: 'in_app', status: 'delivered', message: 'Bạn được phân công cấp phát thuốc cho BN PT-1029.', relatedPatientId: 'PT-1029', relatedEncounterId: 'ENC-1001', relatedWorkflowTaskId: 'TASK-1005', createdAt: '15/10/2023 09:45', deliveredAt: '15/10/2023 09:45', retryCount: 0, read: true },
    { id: 'NOTIF-3', event: 'appointment_reminder', recipientId: 'U-0005', recipientRole: 'patient', channel: 'sms', status: 'failed', message: 'Nhắc lịch khám 22/10/2023 lúc 14:00.', relatedPatientId: 'PT-1029', createdAt: '21/10/2023 08:00', failureReason: 'Không phản hồi từ nhà mạng (timeout)', retryCount: 2, read: false },
    { id: 'NOTIF-4', event: 'escalation_alert', recipientId: 'U-0012', recipientRole: 'care_coordinator', channel: 'in_app', status: 'delivered', message: 'Cảnh báo bất thường mới cần xử lý trong 6 giờ.', relatedPatientId: 'PT-1029', createdAt: '17/10/2023 08:00', deliveredAt: '17/10/2023 08:00', retryCount: 0, read: false },
    { id: 'NOTIF-5', event: 'discharge_task_blocked', recipientId: 'U-0006', recipientRole: 'doctor', channel: 'push', status: 'retrying', message: 'Tác vụ ký hồ sơ đang bị chặn do chờ cấp phát thuốc.', relatedPatientId: 'PT-1029', relatedEncounterId: 'ENC-1001', relatedWorkflowTaskId: 'TASK-1006', createdAt: '15/10/2023 10:00', retryCount: 1, read: false },
    { id: 'NOTIF-6', event: 'record_signed', recipientId: 'U-0005', recipientRole: 'patient', channel: 'email', status: 'queued', message: 'Hồ sơ khám ngày 15/09/2023 đã được bác sĩ ký xác nhận.', relatedPatientId: 'PT-1029', relatedEncounterId: 'ENC-1000', createdAt: '15/09/2023 11:11', retryCount: 0, read: false },
  ];
  ...
  const auditEvents: AuditEvent[] = [
    { id: 'AUD-0001', at: '15/09/2023 09:50', actorId: 'U-0008', actorName: 'Phạm Thị Hoa', role: 'receptionist', action: 'IDENTITY_CREATED', entityType: 'Patient', entityId: 'PT-1029', patientId: 'PT-1029', sourceModule: 'PatientIntake', severity: 'info' },
    { id: 'AUD-0002', at: '15/10/2023 09:38', actorId: 'U-0006', actorName: 'Bs. Nguyễn Thị An', role: 'doctor', action: 'AI_ASSESSMENT_REVIEWED', entityType: 'AIPreliminaryAssessment', entityId: 'AIA-1001', previousState: 'pending', newState: 'partial', reason: 'Phân bố tổn thương điển hình mụn trứng cá hơn viêm nang lông', patientId: 'PT-1029', encounterId: 'ENC-1001', sourceModule: 'DoctorDecision', severity: 'info' },
    { id: 'AUD-0003', at: '15/10/2023 09:40', actorId: 'U-0006', actorName: 'Bs. Nguyễn Thị An', role: 'doctor', action: 'DIAGNOSIS_CONFIRMED', entityType: 'DoctorDiagnosis', entityId: 'DX-1001', newState: 'confirmed', patientId: 'PT-1029', encounterId: 'ENC-1001', sourceModule: 'DoctorDecision', severity: 'info' },
    { id: 'AUD-0004', at: '15/10/2023 09:45', actorId: 'U-0006', actorName: 'Bs. Nguyễn Thị An', role: 'doctor', action: 'CLINICAL_PLAN_APPROVED', entityType: 'ClinicalPlan', entityId: 'PLAN-1001', patientId: 'PT-1029', encounterId: 'ENC-1001', sourceModule: 'DoctorDecision', severity: 'info' },
    { id: 'AUD-0005', at: '15/10/2023 09:50', actorId: 'U-0006', actorName: 'Bs. Nguyễn Thị An', role: 'doctor', action: 'WORKFLOW_INSTANCE_ACTIVATED', entityType: 'WorkflowInstance', entityId: 'WFI-1001', patientId: 'PT-1029', encounterId: 'ENC-1001', sourceModule: 'BPM', severity: 'info' },
    { id: 'AUD-0006', at: '15/10/2023 10:00', actorId: 'U-0011', actorName: 'DS. Vũ Văn Long', role: 'pharmacist', action: 'TASK_STARTED', entityType: 'WorkflowTask', entityId: 'TASK-1005', patientId: 'PT-1029', encounterId: 'ENC-1001', sourceModule: 'BPM', severity: 'info' },
    { id: 'AUD-0007', at: '17/10/2023 08:00', actorId: 'U-0012', actorName: 'Ngô Thị Lan', role: 'care_coordinator', action: 'ESCALATION_TRIGGERED', entityType: 'ClinicalAlert', entityId: 'ALRT-1000', patientId: 'PT-1029', sourceModule: 'CRM', severity: 'warning' },
    ...
    { id: 'AUD-0010', at: '14/10/2023 16:00', actorId: 'U-0014', actorName: 'Nguyễn Mạnh Cường', role: 'medical_administrator', action: 'ENCOUNTER_CREATION_REQUEST_APPROVED', entityType: 'EncounterCreationRequest', entityId: 'ECR-1000', newState: 'approved', patientId: 'PT-1029', sourceModule: 'CRM', severity: 'info' },
    ...
    { id: 'AUD-0012', at: '15/09/2023 11:10', actorId: 'U-0006', actorName: 'Bs. Nguyễn Thị An', role: 'doctor', action: 'MEDICAL_RECORD_SIGNED', entityType: 'MedicalRecord', entityId: 'MREC-1000', newState: 'signed', patientId: 'PT-1029', encounterId: 'ENC-1000', sourceModule: 'EMR', severity: 'info' },
