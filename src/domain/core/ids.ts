...
export type MedicationOrderId = Brand<string, 'MedicationOrderId'>;
export type MedicationOrderEventId = Brand<string, 'MedicationOrderEventId'>;
export type ClinicalPlanRevisionId = Brand<string, 'ClinicalPlanRevisionId'>;
